...
public class MultiViewPager extends ViewPager {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MultiViewPager);
        setMaxWidth(a.getDimensionPixelSize(R.styleable.MultiViewPager_android_maxWidth, -1));
        setMaxHeight(a.getDimensionPixelSize(R.styleable.MultiViewPager_android_maxHeight, -1));
        setMatchChildWidth(a.getResourceId(R.styleable.MultiViewPager_matchChildWidth, 0));
        a.recycle();
    }
